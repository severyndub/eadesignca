...
# --data-raw "{\"filename\":\"${fileName}.png\", \"plottype\":\"line\", \"x\":[\"1\", \"2\", \"3\", \"4\", \"5\"], \"y\":[\"10\", \"8\", \"6\", \"15\", \"22\", \"0\", \"10\", \"8\", \"6\", \"15\"], \"ylab\":[\"first line\", \"second line\"]}"

echo "\n"
echo "https://storage.cloud.google.com/eadesignca1/${fileName}.png"
